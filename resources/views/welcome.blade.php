                ...
                <div class="col-md-12">
                    <div class="brand-wrapper">
                        ...
                        <div class="brand-list">
                            <img src="{{ asset('img/services_logo__1.jpg') }}" alt="">
                            <img src="{{ asset('img/services_logo__2.jpg') }}" alt="">
                            <img src="{{ asset('img/services_logo__3.jpg') }}" alt="">
                            <img src="{{ asset('img/services_logo__4.jpg') }}" alt="">
                            <img src="{{ asset('img/services_logo__1.jpg') }}" alt="">
                            <img src="{{ asset('img/services_logo__2.jpg') }}" alt="">
                            <img src="{{ asset('img/services_logo__3.jpg') }}" alt="">
                            <img src="{{ asset('img/services_logo__4.jpg') }}" alt="">                            
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <div class="single-wid-product">
                            <a href="#"><img src="img/product-thumb-4.jpg" alt="" class="product-thumb"></a>
                            <h2><a href="#">Sony playstation microsoft</a></h2>
                            <div class="product-wid-rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
